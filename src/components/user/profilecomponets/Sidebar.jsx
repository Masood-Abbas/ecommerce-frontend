  ...
  return (
    ...
    <aside className="lg:sticky lg:top-24  col-span-12 md:col-span-3 bg-white shadow-md rounded-2xl p-6 h-fit space-y-6">
      ...
      <div className="border-t pt-4">
        <Button className="flex items-center gap-3 w-full px-3 py-2 rounded-lg text-sm transition text-white bg-(--primary-color) hover:bg-(--hover-primary-color)" onClick={() => setLogoutPopup(true)}>
          <LogOut size={18} />
          Logout
        </Button>
      </div>
