...
import { X,  LayoutDashboard, ShieldUser } from "lucide-react";
import { useSelector } from "react-redux";
import LogoutButton from "@/components/logoutButton";
import { menuItems } from "@/utils/static/admin/sidebar";
      ...
      >
        ...
        <div className="px-6 py-5 flex items-center justify-between border-b border-gray-200">
          <div className="flex items-center gap-3 ">
            <div className="w-9 h-9 rounded-lg bg-(--primary-color) flex items-center justify-center">
              <ShieldUser size={28} className="text-white cursor-default" />
            </div>
            <div>
              <h2 className="text-base font-semibold cursor-default">Admin Pannel</h2>
            </div>
          </div>
        ...
        <div className="px-6 py-4 border-b border-gray-200 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <span className="text-white text-2xl font-medium cursor-default">
